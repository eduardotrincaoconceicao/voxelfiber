...
validateattributes(Nx, {'numeric'}, {'integer', 'positive'}, mfilename, 'Nx')
validateattributes(Ny, {'numeric'}, {'integer', 'positive'}, mfilename, 'Ny')
...
switch stop_criterion
    case 'NumFibers'
        validateattributes(nfib, {'numeric'}, ...
            {'nonempty', 'integer', 'positive', '<=', intmax('int32')}, ...
            mfilename, 'nfib')
    case 'Grammage'
